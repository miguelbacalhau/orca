...
# validation via its validate subcommand), work-loop.workflow.js, and —
# MODELS/EFFORTS only — the one-agent
...
ORCA_STAGES="research spec plan implement review fix commit merge integrate prototype"
